            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "Make every success measure clearly traceable to an objective. "
                        "When a success measure has a numeric target, repeat that exact "
                        "end-state target in the linked objective statement; never use "
                        "different target values for the same outcome. "
                        "If no "
            ...
            "messages": [
                ...
                },
                {
                    ...
                    "content": (
                        ...
                        "feasibility, and internal consistency. Explicitly check that "
                        "each success measure maps clearly to an objective and that a "
                        "numeric measure target is repeated exactly in its linked "
                        "objective without conflicting values. Distinguish a baseline "
                        "or scope number from an end-state target: if the exact target "
                        "is absent, report it as missing unless the objective states a "
                        "different end-state target. Unsupported claims "
